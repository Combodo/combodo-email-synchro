 ...
 * Usage: php decoding-test.php <eml.file> details : to output body contents
 *
 * @since 3.7.7
 */
...
function Usage()
{
	...
	echo "Usage: php decoding-test.php <eml.file> details\n\n";
}
...
$sFilePath = $argv[1];
$bOutputDetails = (isset($argv[2]) && ($argv[2] === 'details'));
